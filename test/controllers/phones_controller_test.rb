...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { inscription_id: @phone.inscription_id, phone: @phone.phone, whatsapp: @phone.whatsapp } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { inscription_id: @phone.inscription_id, phone: @phone.phone, whatsapp: @phone.whatsapp } }
